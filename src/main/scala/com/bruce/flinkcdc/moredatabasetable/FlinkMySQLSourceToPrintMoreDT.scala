package com.bruce.flinkcdc.moredatabasetable
...
/**
 * Description: 分库分表采集-DataStream API
 * Date: 2024/10/27
 *
 * @author bruce
 */
object FlinkMySQLSourceToPrintMoreDT {
  def main(args: Array[String]): Unit = {
    ...
    val mySqlSource = MySqlSource
      ...
      .tableList("data.g.*")// 设置需要获取的表，这里也可以接收多个字符串参数，表名前面需要指定数据库名称
    ...
    env.execute("FlinkMySQLSourceToPrintMoreDT")
  }
}
