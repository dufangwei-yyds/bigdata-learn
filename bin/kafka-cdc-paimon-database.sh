...
-yD state.checkpoints.dir=hdfs://localhost:8020/flink-chk/kafka-database-to-paimon \
/Users/bruce/software/paimon/paimon-flink-action-0.8.2.jar \
kafka_sync_database \
--warehouse hdfs://localhost:8020/paimon \
--database default \
--kafka-conf properties.bootstrap.servers=localhost:9092 \
--kafka-conf topic=products_test\;users \
--kafka-conf properties.group.id=cdc003 \
